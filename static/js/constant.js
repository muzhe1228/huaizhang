var constant = {
  ...
  recaptchaKey: "6LeX1pYUAAAAALvk2OYAEPASzOPacu7NfwamzXAv",
  //http请求地址
  baseUrl: "https://api.pk1955.com",
  //注册url
  registerUrl: "/uac/user/register",
  //发送验证码url
  sendUrl: "/uac/user/sms",
  //二维码接口
  codeUrl: "https://api.pk1955.com/uac/resource/qrcode?text=",
  androidDownload: "http://download.bb678.info/uac/resource/download/app",

  guanWangUrl: "https://www.bbpk.com",
  browserGameUrl: "https://game.bbpk.com/",
...
var data = {
  ...
  activity: {
    rule_size: [
      ...
      {
        content: "用户在游戏中首次充值等价100USDT以上，即可获得最高3%返利；"
      },
      {
        content: "1 USDT固定可兑换100PK，BTC和ETH则随着市场价格波动，浮动兑换；"
      },
      {
